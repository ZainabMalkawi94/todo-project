...
const consoleLogValidationOfAnswers = (validationAnswers) => {
for (let i = 0 ; i < validationAnswers.length; i++){
    console.log (validationAnswers[i]);
}
}

consoleLogValidationOfAnswers(validationOfAnswers(arrayOfAnswers));
